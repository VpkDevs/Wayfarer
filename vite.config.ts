...
export default defineConfig(({ mode }) => {
    ...
    const cleanKey = (key: string | undefined) => {
      ...
      if (k === '' || k === 'GEMINI_API_KEY' || k === 'API_KEY' || k.includes('YOUR_API_KEY') || k === 'undefined') return undefined;
      return k;
    };
    ...
    return {
      ...
      define: {
        ...
        // We use JSON.stringify to ensure it is a valid string literal in the client code.
        // If undefined, we pass strict undefined to avoid "undefined" string issues.
